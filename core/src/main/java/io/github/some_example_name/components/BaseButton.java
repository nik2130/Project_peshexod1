...
public class BaseButton {
    ...
    public int textX;
    public int textY;
    public int buttonWidth = ScreenConfig.DEFAULT_BUTTON_WIDTH;
    public int buttonHeight = ScreenConfig.DEFAULT_BUTTON_HEIGHT;
    ...
    public BaseButton(int x, int y, String text, String texturePath) {
        ...
        font = new BitmapFont();
        font.getData().setScale(ScreenConfig.FONT_SCALE_BUTTON);
